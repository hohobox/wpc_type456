...
/* symbolic name of SpiChannel_NFC1 */
#define SpiChannel_NFC1                     ((Spi_ChannelType) 0U)
#define Spi_SpiChannel_NFC1                 ((Spi_ChannelType) 0U)
#define SpiConf_SpiChannel_SpiChannel_NFC1  ((Spi_ChannelType) 0U)

/* symbolic name of SpiChannel_NFC2 */
#define SpiChannel_NFC2                     ((Spi_ChannelType) 1U)
#define Spi_SpiChannel_NFC2                 ((Spi_ChannelType) 1U)
#define SpiConf_SpiChannel_SpiChannel_NFC2  ((Spi_ChannelType) 1U)
...
/* symbolic name of SpiJob_NFC1 */
#define SpiJob_NFC1                 ((Spi_JobType) 0U)
#define Spi_SpiJob_NFC1             ((Spi_JobType) 0U)
#define SpiConf_SpiJob_SpiJob_NFC1  ((Spi_JobType) 0U)

/* symbolic name of SpiJob_NFC2 */
#define SpiJob_NFC2                 ((Spi_JobType) 1U)
#define Spi_SpiJob_NFC2             ((Spi_JobType) 1U)
#define SpiConf_SpiJob_SpiJob_NFC2  ((Spi_JobType) 1U)
...
#define SPI_MAX_EXTERNAL_DEVICE    ((uint8) 2U)

/** Specifies the identification (ID) for a SPI external device.
 **
 */
/* symbolic names for external device */
#define SPI_EXT_SpiExternalDevice_NFC1  ((Spi_ExtDeviceType) 0U)
#define SpiConf_SpiExternalDevice_SpiExternalDevice_NFC1  ((Spi_ExtDeviceType) 0U)
#define SPI_EXT_SpiExternalDevice_NFC2  ((Spi_ExtDeviceType) 1U)
#define SpiConf_SpiExternalDevice_SpiExternalDevice_NFC2  ((Spi_ExtDeviceType) 1U)
...
#define SPI_SCB1  ((Spi_HWUnitType) 0U)
#define SPI_SCB5  ((Spi_HWUnitType) 1U)

/*------------------[external device configuration]--- */

#define SPI_EXTERNAL_DEVICE_CONFIG  /*  SpiDriver */\
{ \
  { /* SpiExternalDevice_NFC1 */ \
    DioConf_DioChannel_DioChannel_P018_3,  /* chip select id */ \
    SPI_TRUE, /* use chip select */ \
    STD_LOW, /* chip select polarity */ \
    9U, /* OVS register setting (baud rate expected:4000000; supported:4000000) */ \
    STD_LOW,   /* shift clock idle level */ \
    SPI_DATA_SHIFT_EDGE_LEADING, /* data shift edge */ \
  ...
  { /* SpiExternalDevice_NFC2 */ \
    DioConf_DioChannel_DioChannel_P007_3,  /* chip select id */ \
    SPI_TRUE, /* use chip select */ \
    STD_LOW, /* chip select polarity */ \
    9U, /* OVS register setting (baud rate expected:4000000; supported:4000000) */ \
    STD_LOW,   /* shift clock idle level */ \
    ...
    SPI_CS_VIA_GPIO, /* chip select handling method */ \
    SPI_FALSE, /* Force overwrite control registers. */ \
    &Spi_ActiveOvsValues[1] /* Pointer to Active Ovs value */ \
  } \
}
...
{ \
  { /* SpiJob_NFC1 */ \
    Spi_JCh_SpiJob_NFC1,  /* ChannelListPtr */ \
    &NFC1_Spi_JobEnd_Notification,  /* JobEndNotification */ \
  ...
  { /* SpiJob_NFC2 */ \
    Spi_JCh_SpiJob_NFC2,  /* ChannelListPtr */ \
    &NFC2_Spi_JobEnd_Notification,  /* JobEndNotification */ \
    &Spi_ExternalDeviceConfig[1U], /* ExternalDevicePtr */ \
    1U, /* Job Id */ \
    0U,  /* JobPriority */ \
    1U,  /* ChannelCount */ \
    SPI_HWUNIT_SYNC, /* HwUnitSync */ \
...
/* symbolic name of SpiSequence_NFC1 */
#define SpiSequence_NFC1                      ((Spi_SequenceType) 0U)
#define Spi_SpiSequence_NFC1                  ((Spi_SequenceType) 0U)
#define SpiConf_SpiSequence_SpiSequence_NFC1  ((Spi_SequenceType) 0U)

/* symbolic name of SpiSequence_NFC2 */
#define SpiSequence_NFC2                      ((Spi_SequenceType) 1U)
#define Spi_SpiSequence_NFC2                  ((Spi_SequenceType) 1U)
#define SpiConf_SpiSequence_SpiSequence_NFC2  ((Spi_SequenceType) 1U)
...
{ \
  { /* SpiSequence_NFC1 */ \
    Spi_SJb_SpiSequence_NFC1, /* JobListPtr */ \
    &NFC1_Spi_SeqEnd_Notification, /* SeqEndNotification */ \
    &Spi_SpiSequence_NFC1_SharedHwUnitSeqList[0], /* SharedHwUnitSeqListPtr */ \
    1U, /* JobCount */ \
    SPI_SpiSequence_NFC1_SHARED_HW_UNIT_SEQ_COUNT,  /* SharedHwUnitSeqCount */ \
    SPI_FALSE, /* InterruptibleSequence */ \
    0U /* Sequence Id */ \
   }, \
  { /* SpiSequence_NFC2 */ \
    Spi_SJb_SpiSequence_NFC2, /* JobListPtr */ \
    &NFC2_Spi_SeqEnd_Notification, /* SeqEndNotification */ \
    &Spi_SpiSequence_NFC2_SharedHwUnitSeqList[0], /* SharedHwUnitSeqListPtr */ \
    1U, /* JobCount */ \
    SPI_SpiSequence_NFC2_SHARED_HW_UNIT_SEQ_COUNT,  /* SharedHwUnitSeqCount */ \
    SPI_FALSE, /* InterruptibleSequence */ \
    1U /* Sequence Id */ \
   }  \
}
...
/* for SpiDriver */
#define  SPI_SpiSequence_NFC1_SHARED_HW_UNIT_SEQ_COUNT   1U
#define  SPI_SpiSequence_NFC1_SHARED_HW_UNIT_SEQ_LIST { \
  0U \
}

#define  SPI_SpiSequence_NFC2_SHARED_HW_UNIT_SEQ_COUNT   1U
#define  SPI_SpiSequence_NFC2_SHARED_HW_UNIT_SEQ_LIST { \
  1U \
}
