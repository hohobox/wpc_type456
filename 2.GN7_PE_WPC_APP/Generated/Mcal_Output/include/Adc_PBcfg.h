...
#define ADC_INDEX_INTERRUPT_96    ( 0U )  /* Interrupt index for ADC logical channel0 */
#define ADC_INDEX_INTERRUPT_97    ( 1U )  /* Interrupt index for ADC logical channel1 */
