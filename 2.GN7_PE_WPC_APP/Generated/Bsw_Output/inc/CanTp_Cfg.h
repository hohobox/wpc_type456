...
#define CANTP_CFG_SW_PATCH_VERSION                         (4)
...
#define CANTP_SW_PATCH_VERSION                             (4)
...
#define CANTP_RX_FUNCTIONAL_ADDRESSING (STD_OFF)
...
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_1_Pdu_ISignalIPdu_LCAN_L_TP_L_WPC_FD_BDC_FD\
  ((PduIdType)1)

/* CanTp Rx Nsdu Handle(s) */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_0_Pdu_DcmIPdu_BCAN_GST_WPC ((PduIdType)0)
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_1_Pdu_ISignalIPdu_LCAN_L_TP_BDC_FD_L_WPC_FD\
  ((PduIdType)1)
