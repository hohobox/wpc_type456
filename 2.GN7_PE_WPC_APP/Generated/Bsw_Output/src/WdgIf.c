  ...
  (uint8 DeviceIndex, WdgIf_ModeType WdgMode)
{
  ...
  */
  ...
  default:
    /* Report to DET */
    (void)Det_ReportError(WDGIF_MODULE_ID, WDGIF_INSTANCE_ID, WDGIF_SETMODE_SID, WDGIF_E_PARAM_DEVICE);
  ...
  */
  switch(DeviceIndex)
  {
    ...
    case 1:
      ...
      break;
    default:
      (void)Det_ReportError(WDGIF_MODULE_ID, WDGIF_ZERO, WDGIF_SETTRIGGERCONDITION_SID, WDGIF_E_PARAM_DEVICE);
      break;
  }
}
#define WDGIF_STOP_SEC_CODE
