...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Csm_R44\generator\Bswmdt_Csm.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Csm_R44\generator\Swcdt_Bsw_Csm.template
