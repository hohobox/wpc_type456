...
cy_en_scb_uart_status_t Cy_SCB_UART_Init(volatile stc_SCB_t *base, cy_stc_scb_uart_config_t const *config, cy_stc_scb_uart_context_t *context)
{
    ...
    un_SCB_CTRL_t           temp_CTRL           = {0};
    un_SCB_UART_CTRL_t      temp_UART_CTRL      = {0};
    un_SCB_UART_RX_CTRL_t   temp_UART_RX_CTRL   = {0};
    un_SCB_RX_CTRL_t        temp_RX_CTRL        = {0};
    un_SCB_RX_MATCH_t       temp_RX_MATCH       = {0};
    un_SCB_UART_TX_CTRL_t   temp_UART_TX_CTRL   = {0};
    un_SCB_TX_CTRL_t        temp_TX_CTRL        = {0};
    un_SCB_RX_FIFO_CTRL_t   temp_RX_FIFO_CTRL   = {0};
    un_SCB_UART_FLOW_CTRL_t temp_UART_FLOW_CTRL = {0};
    un_SCB_TX_FIFO_CTRL_t   temp_TX_FIFO_CTRL   = {0};
...
static void HandleDataTransmit(volatile stc_SCB_t *base, cy_stc_scb_uart_context_t *context)
{
    ...
    if ((fifoSize != Cy_SCB_GetNumInTxFifo(base)) && (1UL == context->txBufSize))
    {
        ...
        Spi_Com_SchMEnterCriticalSection(); // 모빌젠 spi의 api 대신 사용
        ...
        Spi_Com_SchMExitCriticalSection(); // 모빌젠 spi의 api 대신 사용
