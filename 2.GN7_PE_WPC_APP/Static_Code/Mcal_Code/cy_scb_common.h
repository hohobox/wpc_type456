...
__STATIC_INLINE void Cy_SCB_SetRxFifoLevel(volatile stc_SCB_t *base, uint32_t rxLevel)
{
    ...
    temp_RX_FIFO_CTRL.u32Register                 = base->unRX_FIFO_CTRL.u32Register;
    base->unRX_FIFO_CTRL.stcField.u8TRIGGER_LEVEL = 0;
    temp_RX_FIFO_CTRL.stcField.u8TRIGGER_LEVEL    = rxLevel;
...
__STATIC_INLINE void Cy_SCB_ClearRxFifo(volatile stc_SCB_t* base)
{
    base->unRX_FIFO_CTRL.stcField.u1CLEAR = 1;
    base->unRX_FIFO_CTRL.stcField.u1CLEAR = 0;
...
__STATIC_INLINE void Cy_SCB_SetTxFifoLevel(volatile stc_SCB_t *base, uint32_t txLevel)
{
    ...
    // get-clear-modify-write
    temp_TX_FIFO_CTRL.u32Register                 = base->unTX_FIFO_CTRL.u32Register;
    base->unTX_FIFO_CTRL.stcField.u8TRIGGER_LEVEL = 0;
    temp_TX_FIFO_CTRL.stcField.u8TRIGGER_LEVEL    = txLevel;
...
__STATIC_INLINE void Cy_SCB_ClearTxFifo(volatile stc_SCB_t *base)
{
    base->unTX_FIFO_CTRL.stcField.u1CLEAR = 1;
    base->unTX_FIFO_CTRL.stcField.u1CLEAR = 0;
...
__STATIC_INLINE void Cy_SCB_SetEzMode(volatile stc_SCB_t *base, bool ezMode)
{
    if (ezMode)
    {
        base->unCTRL.stcField.u1EZ_MODE = 1;
    }
    else
    {
        base->unCTRL.stcField.u1EZ_MODE = 0;
    }
}
