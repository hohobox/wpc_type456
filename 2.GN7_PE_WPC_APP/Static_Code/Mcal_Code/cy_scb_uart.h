...
__STATIC_INLINE void Cy_SCB_UART_EnableCts(volatile stc_SCB_t *base)
{
    base->unUART_FLOW_CTRL.stcField.u1CTS_ENABLED = 1;
}
...
__STATIC_INLINE void Cy_SCB_UART_DisableCts(volatile stc_SCB_t *base)
{
    base->unUART_FLOW_CTRL.stcField.u1CTS_ENABLED = 0;
}
...
__STATIC_INLINE void Cy_SCB_UART_SetRtsFifoLevel(volatile stc_SCB_t *base, uint32_t rxFifoLevel)
{
    un_SCB_UART_FLOW_CTRL_t temp_UART_FLOW_CTRL;

    // get-clear-modify-write
    temp_UART_FLOW_CTRL.u32Register                 = base->unUART_FLOW_CTRL.u32Register;
    base->unUART_FLOW_CTRL.stcField.u8TRIGGER_LEVEL = 0;
    temp_UART_FLOW_CTRL.stcField.u8TRIGGER_LEVEL    = rxFifoLevel;
...
__STATIC_INLINE void Cy_SCB_UART_DisableSkipStart(volatile stc_SCB_t *base)
{
    base->unUART_RX_CTRL.stcField.u1LIN_MODE = 0;
}
/** \} group_scb_uart_general_functions */
