...
*
*******************************************************************************/
#define _CLR_SET_FLD16U(reg, field, value) (((reg) & ((uint16_t)(~(field ## _Msk)))) | (_VAL2FLD(field, value)))
...
*
*******************************************************************************/
#define _CLR_SET_FLD8U(reg, field, value) (((reg) & ((uint8_t)(~(field ## _Msk)))) | (_VAL2FLD(field, value)))
