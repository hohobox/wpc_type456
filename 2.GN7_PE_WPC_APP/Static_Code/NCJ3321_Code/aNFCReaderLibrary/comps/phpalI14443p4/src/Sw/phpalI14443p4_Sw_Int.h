...
*/
#define PHPALI14443P4_SW_INT_VENDOR_ID                    43           /**< @brief AUTOSAR vendor ID*/
#define PHPALI14443P4_SW_INT_MODULE_ID                    255          /**< @brief AUTOSAR module ID*/
#define PHPALI14443P4_SW_INT_AR_RELEASE_MAJOR_VERSION     4            /**< @brief AUTOSAR release major version*/
#define PHPALI14443P4_SW_INT_AR_RELEASE_MINOR_VERSION     3            /**< @brief AUTOSAR release minor version*/
#define PHPALI14443P4_SW_INT_AR_RELEASE_REVISION_VERSION  1            /**< @brief AUTOSAR release revision*/
#define PHPALI14443P4_SW_INT_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PHPALI14443P4_SW_INT_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PHPALI14443P4_SW_INT_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PHPALI14443P4_SW_INT_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "phpalI14443p4_Sw_Int.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PHPALI14443P4_SW_INT_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PHPALI14443P4_SW_INT_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PHPALI14443P4_SW_INT_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of phpalI14443p4_Sw_Int.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PHPALI14443P4_SW_INT_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PHPALI14443P4_SW_INT_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PHPALI14443P4_SW_INT_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of phpalI14443p4_Sw_Int.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
#if ((PHPALI14443P4_SW_INT_AR_RELEASE_MAJOR_VERSION == 4) && (PHPALI14443P4_SW_INT_AR_RELEASE_MINOR_VERSION == 0))
	#include <MemMap.h>
#else
...
FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p4_Sw_BuildIBlock(
                                        VAR(uint8, ANFCRL_VAR) bCidEnabled,    /**< [In] Set to != 0 to enable CID byte */
                                        VAR(uint8, ANFCRL_VAR) bCid,           /**< [In] CID byte */
                                        VAR(uint8, ANFCRL_VAR) bNadEnabled,    /**< [In] Set to != 0 to enable NAD byte */
                                        VAR(uint8, ANFCRL_VAR) bNad,           /**< [In] NAD byte */
                                        VAR(uint8, ANFCRL_VAR) bPcbBlockNum,   /**< [In] PCB block number bit */
                                        VAR(uint8, ANFCRL_VAR) bChaining,      /**< [In] Set to != 0 if chaining bit should be set */
                                        P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pTxBuffer,    /**< [Out] transmit buffer */
                                        P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pTxLength    /**< [Out] number of bytes to send */
                                        );
...
FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p4_Sw_BuildRBlock(
                                        ...
                                        VAR(uint8, ANFCRL_VAR) bCid,           /**< [In] CID byte */
                                        VAR(uint8, ANFCRL_VAR) bPcbBlockNum,   /**< [In] PCB block number bit */
                                        VAR(uint8, ANFCRL_VAR) bIsAck,         /**< [In] Set to != 0 if an ACK should be generated */
                                        P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pTxBuffer,    /**< [Out] transmit buffer */
                                        P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pTxLength    /**< [Out] number of bytes to send */
                                        );
...
FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p4_Sw_BuildSBlock(
                                        VAR(uint8, ANFCRL_VAR) bCidEnabled,    /**< [In] Set to != 0 to enable CID byte */
                                        VAR(uint8, ANFCRL_VAR) bCid,           /**< [In] CID byte */
                                        VAR(uint8, ANFCRL_VAR) bIsWtx,         /**< [In] Set to != 0 if a WTX frame should be generated */
                                        VAR(uint8, ANFCRL_VAR) bWtxm,          /**< [In] WTXM bits, used if /ref bIsWtx is set */
                                        P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pTxBuffer,    /**< [Out] transmit buffer */
                                        P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pTxLength    /**< [Out] number of bytes to send */
                                        );
...
FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p4_Sw_IsValidIBlock(
    VAR(uint8, ANFCRL_VAR) bCheckCid,      /**< [In] Set to != 0 to enable CID check */
    VAR(uint8, ANFCRL_VAR) bCid,           /**< [In] Current CID for comparison */
    VAR(uint8, ANFCRL_VAR) bCheckNad,      /**< [In] Set to != 0 to enable NAD check */
    VAR(uint8, ANFCRL_VAR) bNad,           /**< [In] Current NAD for comparison */
    P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pRxBuffer,    /**< [In] Received data */
    VAR(uint16, ANFCRL_VAR) wRxLength      /**< [In] Number of received data bytes */
    );
...
FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p4_Sw_IsoHandling(
    ...
    VAR(uint8, ANFCRL_VAR) bRetryCount,                            /**< [In] number of already performed retry. */
    ...
    P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pRxLength                            /**< [In] Received data bytes */
    );
