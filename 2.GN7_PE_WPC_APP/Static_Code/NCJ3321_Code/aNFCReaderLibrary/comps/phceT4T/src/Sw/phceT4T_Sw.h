...
*/
#define PHCET4T_SW_VENDOR_ID                    43           /**< @brief AUTOSAR vendor ID*/
#define PHCET4T_SW_MODULE_ID                    255          /**< @brief AUTOSAR module ID*/
#define PHCET4T_SW_AR_RELEASE_MAJOR_VERSION     4            /**< @brief AUTOSAR release major version*/
#define PHCET4T_SW_AR_RELEASE_MINOR_VERSION     3            /**< @brief AUTOSAR release minor version*/
#define PHCET4T_SW_AR_RELEASE_REVISION_VERSION  1            /**< @brief AUTOSAR release revision*/
#define PHCET4T_SW_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PHCET4T_SW_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PHCET4T_SW_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PHCET4T_SW_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "phceT4T_Sw.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PHCET4T_SW_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PHCET4T_SW_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PHCET4T_SW_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of phceT4T_Sw.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PHCET4T_SW_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PHCET4T_SW_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PHCET4T_SW_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of phceT4T_Sw.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
#if ((PHCET4T_SW_AR_RELEASE_MAJOR_VERSION == 4) && (PHCET4T_SW_AR_RELEASE_MINOR_VERSION == 0))
	#include <MemMap.h>
#else
