...
/** 
@{
* @brief Anfc Reader Library module.
*/
#define ANFCRL_CODE
#define ANFCRL_CONST
#define ANFCRL_APPL_CONST
#define ANFCRL_APPL_CODE
#define ANFCRL_APPL_DATA
#define ANFCRL_CALLOUT_CODE
#define ANFCRL_VAR_NOINIT
#define ANFCRL_VAR_POWER_ON_INIT
#define ANFCRL_VAR_FAST
#define ANFCRL_VAR
/**@}*/
