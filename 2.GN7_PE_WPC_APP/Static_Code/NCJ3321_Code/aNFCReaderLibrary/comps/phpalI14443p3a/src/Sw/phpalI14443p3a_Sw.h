...
*/
#define PHPALI14443P3A_SW_VENDOR_ID                      43         /**< @brief AUTOSAR vendor ID*/
#define PHPALI14443P3A_SW_AR_RELEASE_MAJOR_VERSION       4       /**< @brief AUTOSAR release major version*/
#define PHPALI14443P3A_SW_AR_RELEASE_MINOR_VERSION       3       /**< @brief AUTOSAR release minor version*/
#define PHPALI14443P3A_SW_AR_RELEASE_REVISION_VERSION    1       /**< @brief AUTOSAR release revision*/
#define PHPALI14443P3A_SW_SW_MAJOR_VERSION               1            /**< @brief The major version of the SW module*/
#define PHPALI14443P3A_SW_SW_MINOR_VERSION               0            /**< @brief The minor version of the SW module*/
#define PHPALI14443P3A_SW_SW_PATCH_VERSION               0            /**< @brief The patch version of the SW module*/
...
==================================================================================================*/
 ...
 #if (PHPALI14443P3A_SW_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
     #error "phhalHw_Ncx3321_Wait.h and CDD_AnfcRL_Cfg.h have different vendor ids"
 #endif
 /* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
 #if ((PHPALI14443P3A_SW_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (PHPALI14443P3A_SW_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
     (PHPALI14443P3A_SW_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
     #error "AutoSar Version Numbers of phhalHw_Ncx3321_Wait.h and CDD_AnfcRL_Cfg.h are different"
 #endif
 /* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
 #if ((PHPALI14443P3A_SW_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
     (PHPALI14443P3A_SW_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
     ( PHPALI14443P3A_SW_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
...
#if ((PHPALI14443P3A_SW_AR_RELEASE_MAJOR_VERSION == 4) && (PHPALI14443P3A_SW_AR_RELEASE_MINOR_VERSION == 0))
	#include <MemMap.h>
#else
...
FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p3a_Sw_RequestA(
                                      P2VAR(phpalI14443p3a_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,
                                      P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pAtqa
                                      );

FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p3a_Sw_WakeUpA(
                                     P2VAR(phpalI14443p3a_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,
                                     P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pAtqa
                                     );

FUNC(phStatus_t, ANFCRL_CODE) phpalI14443p3a_Sw_HaltA(
                                   P2VAR(phpalI14443p3a_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams
                                   );
