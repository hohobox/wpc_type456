...
*/
#define PHALICODE_SW_VENDOR_ID                    43         /**< @brief AUTOSAR vendor ID*/
#define PHALICODE_SW_MODULE_ID                    255                /**< @brief AUTOSAR module ID*/
#define PHALICODE_SW_AR_RELEASE_MAJOR_VERSION     4       /**< @brief AUTOSAR release major version*/
#define PHALICODE_SW_AR_RELEASE_MINOR_VERSION     3       /**< @brief AUTOSAR release minor version*/
#define PHALICODE_SW_AR_RELEASE_REVISION_VERSION  1       /**< @brief AUTOSAR release revision*/
#define PHALICODE_SW_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PHALICODE_SW_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PHALICODE_SW_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PHALICODE_SW_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "phalICode_Sw.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PHALICODE_SW_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PHALICODE_SW_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PHALICODE_SW_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of phalICode_Sw.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PHALICODE_SW_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PHALICODE_SW_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PHALICODE_SW_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of phalICode_Sw.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
#if ((PHALICODE_SW_AR_RELEASE_MAJOR_VERSION == 4) && (PHALICODE_SW_AR_RELEASE_MINOR_VERSION == 0))
	#include <MemMap.h>
#else
...
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_ExtendedGetMultipleBlockSecurityStatus(
    P2VAR(phalICode_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams, VAR(uint16, ANFCRL_VAR) wBlockNo, VAR(uint16, ANFCRL_VAR) wNoOfBlocks, P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pStatus,
    P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pStatusLen);
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_SetEAS(P2VAR(phalICode_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,
    VAR(uint8, ANFCRL_VAR) bOption);
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_ResetEAS(P2VAR(phalICode_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,
    VAR(uint8, ANFCRL_VAR) bOption);
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_LockEAS(P2VAR(phalICode_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,
    VAR(uint8, ANFCRL_VAR) bOption);
...
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_EASAlarm(P2VAR(phalICode_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,
    VAR(uint8, ANFCRL_VAR) bOption, P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pEasIdValue, VAR(uint8, ANFCRL_VAR) bEasIdMaskLen,
    P2VAR(uint8*, AUTOMATIC, ANFCRL_APPL_DATA) ppEas, P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pEasLen);
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_PasswordProtectEAS(
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Sw_PasswordProtectAFI(
    P2VAR(phalICode_Sw_DataParams_t, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams);
