...
*/
#define PHALICODE_INT_VENDOR_ID                    43         /**< @brief AUTOSAR vendor ID*/
#define PHALICODE_INT_MODULE_ID                    255                /**< @brief AUTOSAR module ID*/
#define PHALICODE_INT_AR_RELEASE_MAJOR_VERSION     4       /**< @brief AUTOSAR release major version*/
#define PHALICODE_INT_AR_RELEASE_MINOR_VERSION     3       /**< @brief AUTOSAR release minor version*/
#define PHALICODE_INT_AR_RELEASE_REVISION_VERSION  1       /**< @brief AUTOSAR release revision*/
#define PHALICODE_INT_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PHALICODE_INT_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PHALICODE_INT_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PHALICODE_INT_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "phalICode_Int.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PHALICODE_INT_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PHALICODE_INT_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PHALICODE_INT_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of phalICode_Int.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PHALICODE_INT_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PHALICODE_INT_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PHALICODE_INT_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of phalICode_Int.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
#if ((PHALICODE_INT_AR_RELEASE_MAJOR_VERSION == 4) && (PHALICODE_INT_AR_RELEASE_MINOR_VERSION == 0))
	#include <MemMap.h>
#else
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Int_FastReadMultipleBlocks(P2VAR(void, AUTOMATIC, ANFCRL_APPL_DATA) pPalSli15693DataParams,
    VAR(uint8, ANFCRL_VAR) bEnableBuffering, VAR(uint8, ANFCRL_VAR) bOption, VAR(uint8, ANFCRL_VAR) bBlockNo, VAR(uint8, ANFCRL_VAR) bNumBlocks, P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pData,
P2VAR(uint16, AUTOMATIC, ANFCRL_APPL_DATA) pDataLen);
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Int_EASAlarm(
	P2VAR(void, AUTOMATIC, ANFCRL_APPL_DATA) pPalSli15693DataParams,
    VAR(uint8, ANFCRL_VAR) bOption,
 ...
 *          Other Depending on implementation and underlying component.
 */
FUNC(phStatus_t, ANFCRL_CODE) phalICode_Int_WriteEASID(
	P2VAR(void, AUTOMATIC, ANFCRL_APPL_DATA) pPalSli15693DataParams,
    P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pEasIdValue);
