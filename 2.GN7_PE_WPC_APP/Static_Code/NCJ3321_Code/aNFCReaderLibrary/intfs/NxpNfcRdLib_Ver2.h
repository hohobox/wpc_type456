 ...
 * Software/Source Code.
  *******************************************************************************/
 /**
*   @file    NxpNfcRdLib_Ver2.h
*   @version 1.0.0
*
*   @brief   AUTOSAR NxpNfcRdLib_Ver2 - NFC API usage in common use cases.
...
/*==================================================================================================
==================================================================================================*/
#ifndef NXPNFCRDLIB_VERSION_INFO2_H_INCLUDED
#define NXPNFCRDLIB_VERSION_INFO2_H_INCLUDED
...
*/
#define NXPNFCRDLIB_VER_VENDOR_ID2                    43           /**< @brief AUTOSAR vendor ID*/
#define NXPNFCRDLIB_VER_MODULE_ID2                    255          /**< @brief AUTOSAR module ID*/
#define NXPNFCRDLIB_VER_AR_RELEASE_MAJOR_VERSION2     4            /**< @brief AUTOSAR release major version*/
#define NXPNFCRDLIB_VER_AR_RELEASE_MINOR_VERSION2     3            /**< @brief AUTOSAR release minor version*/
#define NXPNFCRDLIB_VER_AR_RELEASE_REVISION_VERSION2  1            /**< @brief AUTOSAR release revision*/
#define NXPNFCRDLIB_VER_SW_MAJOR_VERSION2             1            /**< @brief The major version of the SW module*/
#define NXPNFCRDLIB_VER_SW_MINOR_VERSION2             0            /**< @brief The minor version of the SW module*/
#define NXPNFCRDLIB_VER_SW_PATCH_VERSION2             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (NXPNFCRDLIB_VER_VENDOR_ID2 != ANFCRL_CFG_VENDOR_ID)
    #error "NxpNfcRdLib_Ver2.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((NXPNFCRDLIB_VER_AR_RELEASE_MAJOR_VERSION2    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (NXPNFCRDLIB_VER_AR_RELEASE_MINOR_VERSION2    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (NXPNFCRDLIB_VER_AR_RELEASE_REVISION_VERSION2 != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of NxpNfcRdLib_Ver2.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((NXPNFCRDLIB_VER_SW_MAJOR_VERSION2 != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (NXPNFCRDLIB_VER_SW_MINOR_VERSION2 != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (NXPNFCRDLIB_VER_SW_PATCH_VERSION2 != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of NxpNfcRdLib_Ver2.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
*                                      DEFINES AND MACROS
==================================================================================================*/
#define NxpNfcRdLib_VER_FILEDESCRIPTION2    "NxpNfcRdLib_00.14.00_20180921"
#define NxpNfcRdLib_VER_FILEVERSION2         0,14,0,0
#define NxpNfcRdLib_VER_FILEVERSION_STR2    "0,14,0,0"
#define NxpNfcRdLib_VER_PRODUCTVERSION2      0,14,0,0
#define NxpNfcRdLib_VER_PRODUCTVERSION_STR2 "0,14,0,0"
#define NxpNfcRdLib_VER_MAJOR2  (0)
#define NxpNfcRdLib_VER_MINOR2  (14)
#define NxpNfcRdLib_VER_DEV2    (0)
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
...
#endif
#endif /* NXPNFCRDLIB_VERSION_INFO2_H_INCLUDED */
