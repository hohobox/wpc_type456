...
*/
#define PH_TYPEDEFS_VENDOR_ID                    43           /**< @brief AUTOSAR vendor ID*/
#define PH_TYPEDEFS_MODULE_ID                    255          /**< @brief AUTOSAR module ID*/
#define PH_TYPEDEFS_AR_RELEASE_MAJOR_VERSION     4            /**< @brief AUTOSAR release major version*/
#define PH_TYPEDEFS_AR_RELEASE_MINOR_VERSION     3            /**< @brief AUTOSAR release minor version*/
#define PH_TYPEDEFS_AR_RELEASE_REVISION_VERSION  1            /**< @brief AUTOSAR release revision*/
#define PH_TYPEDEFS_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PH_TYPEDEFS_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PH_TYPEDEFS_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PH_TYPEDEFS_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "ph_Typedefs.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PH_TYPEDEFS_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PH_TYPEDEFS_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PH_TYPEDEFS_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of ph_Typedefs.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PH_TYPEDEFS_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PH_TYPEDEFS_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PH_TYPEDEFS_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of ph_Typedefs.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
 ...
 */
typedef volatile uint32_t * pReg32_t;	/* NIDEC_PORTING */
