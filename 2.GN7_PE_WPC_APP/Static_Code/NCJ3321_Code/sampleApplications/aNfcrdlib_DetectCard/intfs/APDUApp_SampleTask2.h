...
#ifndef APDUAPP_SAMPLETASK2_H
#define APDUAPP_SAMPLETASK2_H
...
FUNC(phStatus_t2, ANFCRL_CODE) ISO14443A_SampleTask2(
    ...
    VAR(uint8, ANFCRL_VAR) apdu, P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) txBuffer2, VAR(uint16, ANFCRL_VAR) length2);
