...
*
*   @addtogroup phbalReg Bus Abstraction Layer (BAL)
*   @{
*/
/*==================================================================================================
...
*/
#define PHBALREG_VENDOR_ID                    43           /**< @brief AUTOSAR vendor ID*/
#define PHBALREG_MODULE_ID                    255          /**< @brief AUTOSAR module ID*/
#define PHBALREG_AR_RELEASE_MAJOR_VERSION     4            /**< @brief AUTOSAR release major version*/
#define PHBALREG_AR_RELEASE_MINOR_VERSION     3            /**< @brief AUTOSAR release minor version*/
#define PHBALREG_AR_RELEASE_REVISION_VERSION  1            /**< @brief AUTOSAR release revision*/
#define PHBALREG_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PHBALREG_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PHBALREG_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PHBALREG_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "phbalReg.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PHBALREG_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PHBALREG_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PHBALREG_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of phbalReg.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PHBALREG_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PHBALREG_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PHBALREG_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of phbalReg.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
/**
 * end of group phbalReg Bus Abstraction Layer (BAL)
 * @}
 */
/*==================================================================================================
*                                             ENUMS
...
typedef struct
{
    VAR(uint16, ANFCRL_VAR) wId;              /**< Layer ID for this BAL component, NEVER MODIFY! */
    VAR(uint8, ANFCRL_VAR) bBalType;         /**< BAL type used by HAL to configure the BAL configured at runtime. */
} phbalReg_Type_t;
...
#if ((PHBALREG_AR_RELEASE_MAJOR_VERSION == 4) && (PHBALREG_AR_RELEASE_MINOR_VERSION == 0))
	#include <MemMap.h>
#else
...
FUNC(phStatus_t, ANFCRL_CODE) phbalReg_Init(
		P2VAR(void, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,    /**< [In] Pointer to this layer's parameter structure phbalReg_Type_t. */
        VAR(uint16, ANFCRL_VAR) wSizeOfDataParams              /**< [In] Size of this layer's parameter structure. */
        );
...
FUNC(phStatus_t, ANFCRL_CODE) phbalReg_Exchange(
                             ...
                             VAR(uint16, ANFCRL_VAR) wOption,      /**< [In] Option parameter, for future use. */
                             P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pTxBuffer,   /**< [In] Data to transmit. */
                             VAR(uint16, ANFCRL_VAR) wTxLength,    /**< [In] Number of bytes to transmit, if 0 Tx is not performed. */
                             VAR(uint16, ANFCRL_VAR) wRxBufSize,   /**< [In] Size of receive buffer / Number of bytes to receive (depending on implementation). If 0 Rx is not performed.  */
                             P2VAR(uint8, AUTOMATIC, ANFCRL_APPL_DATA) pRxBuffer,   /**< [Out] Received data. */
...
FUNC(phStatus_t, ANFCRL_CODE) phbalReg_SetConfig(
                              P2VAR(void, AUTOMATIC, ANFCRL_APPL_DATA) pDataParams,   /**< [In] Pointer to this layer's parameter structure. */
                              VAR(uint16, ANFCRL_VAR) wConfig,     /**< [In] Configuration identifier, for future use. */
