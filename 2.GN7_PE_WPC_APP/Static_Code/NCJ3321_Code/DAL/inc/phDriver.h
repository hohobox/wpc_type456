...
*/
#define PHDRIVER_VENDOR_ID                    43           /**< @brief AUTOSAR vendor ID*/
#define PHDRIVER_MODULE_ID                    255          /**< @brief AUTOSAR module ID*/
#define PHDRIVER_AR_RELEASE_MAJOR_VERSION     4            /**< @brief AUTOSAR release major version*/
#define PHDRIVER_AR_RELEASE_MINOR_VERSION     3            /**< @brief AUTOSAR release minor version*/
#define PHDRIVER_AR_RELEASE_REVISION_VERSION  1            /**< @brief AUTOSAR release revision*/
#define PHDRIVER_SW_MAJOR_VERSION             1            /**< @brief The major version of the SW module*/
#define PHDRIVER_SW_MINOR_VERSION             0            /**< @brief The minor version of the SW module*/
#define PHDRIVER_SW_PATCH_VERSION             0            /**< @brief The patch version of the SW module*/

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same vendor */
#if (PHDRIVER_VENDOR_ID != ANFCRL_CFG_VENDOR_ID)
    #error "phDriver.h and CDD_AnfcRL_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same Autosar version */
#if ((PHDRIVER_AR_RELEASE_MAJOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MAJOR_VERSION) || \
    (PHDRIVER_AR_RELEASE_MINOR_VERSION    != ANFCRL_CFG_AR_RELEASE_MINOR_VERSION) || \
    (PHDRIVER_AR_RELEASE_REVISION_VERSION != ANFCRL_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of phDriver.h and CDD_AnfcRL_Cfg.h are different"
#endif
/* Check if current file and CDD_AnfcRL_Cfg.h header file are of the same software version */
#if ((PHDRIVER_SW_MAJOR_VERSION != ANFCRL_CFG_SW_MAJOR_VERSION) || \
    (PHDRIVER_SW_MINOR_VERSION != ANFCRL_CFG_SW_MINOR_VERSION) || \
    (PHDRIVER_SW_PATCH_VERSION != ANFCRL_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of phDriver.h and CDD_AnfcRL_Cfg.h are different"
#endif
/** @} */
/*==================================================================================================
*                                          CONSTANTS
...
#endif
#ifdef ANFCRL_HAL_HW_DEVICE_NCX3320
#define PIN_IRQ_TRIGGER_TYPE      IRQ_TRIGGER_TYPE_FALLINGEDGE   /*MISRA rule 20.9 line 470 phhalHw_Ncx3320_Int.h*/
#endif
/*****************************************************************
 * Front End Reset logic level settings
 ****************************************************************/
#define PH_DRIVER_SET_HIGH            1u          /**< Logic High. */
#define PH_DRIVER_SET_LOW             0u          /**< Logic Low. */
...
/*!
 ...
 IRQ Line level .
 */
#define PIN_IRQ_IDLE_HIGH               PH_DRIVER_SET_HIGH
#define PIN_IRQ_IDLE_LOW                PH_DRIVER_SET_LOW
 ...
 */
	...
	#define PH_DRIVER_PIN_IRQ_ACTIVE 		1u
	#define PH_DRIVER_PIN_IRQ_IDLE 			0u
#elif (PIN_IRQ_TRIGGER_TYPE == IRQ_TRIGGER_TYPE_FALLINGEDGE)
	#define PH_DRIVER_PIN_IRQ_ACTIVE 		0u
	#define PH_DRIVER_PIN_IRQ_IDLE 			1u
#else
 ...
 * Low byte : Error Specifier.
 */
typedef VAR(uint16, ANFCRL_VAR) phStatus_t;
#endif
