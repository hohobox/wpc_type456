...
/* J1979-2  */
#define DEM_DATA_ELEMENT_MONITOR_ACTIVITY_DATA                    ((uint8)0x20|DEM_DATA_ELEMENT_INTERNAL)
#define DEM_DATA_ELEMENT_IUMPR                                    ((uint8)0x40|DEM_DATA_ELEMENT_INTERNAL)
#define DEM_DATA_ELEMENT_DTR                                      ((uint8)0x80|DEM_DATA_ELEMENT_INTERNAL)
...
/* Trace: DEM_19792_14 */
#define DEM_DTC_GROUP_EMISSION_REL_DTCS                           0xFFFF33
#else
...
#else
#define DEM_DTC_WWHOBD_CLASS_A                                     ((uint8)0x00)
#define DEM_DTC_WWHOBD_CLASS_B1                                    ((uint8)0x01)
#define DEM_DTC_WWHOBD_CLASS_B2                                    ((uint8)0x02)
#define DEM_DTC_WWHOBD_CLASS_C                                     ((uint8)0x03)
#define DEM_DTC_WWHOBD_CLASS_NOCLASS                               ((uint8)0x04)
#endif /* J19792 */
...
/* Byte B */
#define DEM_OBD_RDY_BYTEB_0_SUPPORTED_ENABLE_MISF                                 (0x01)
#define DEM_OBD_RDY_BYTEB_1_SUPPORTED_ENABLE_FLSYS                                (0x02)
#define DEM_OBD_RDY_BYTEB_2_SUPPORTED_ENABLE_CMPRCMPT                             (0X04)
#define DEM_OBD_RDY_BYTEB_3_COMPRESSION_SPARK_IGNITION                            (0x08)
#define DEM_OBD_RDY_BYTEB_4_COMPLETENESS_READINESS_MISF                           (0x10)
#define DEM_OBD_RDY_BYTEB_5_COMPLETENESS_READINESS_FLSYS                          (0x20)
#define DEM_OBD_RDY_BYTEB_6_COMPLETENESS_READINESS_CMPRCMPT                       (0X40)
#define DEM_OBD_RDY_BYTEB_7_COMPLETENESS_READINESS_RESERVED                       (0x80)

/* Byte C - Spark + Compression */
#define DEM_OBD_RDY_BYTEC_0_SPARK_SUPPORTED_ENABLED_CAT                            (0x01)
#define DEM_OBD_RDY_BYTEC_0_COMPRESSION_SUPPORTED_ENABLED_HCCAT                    (0x01)

#define DEM_OBD_RDY_BYTEC_1_SPARK_SUPPORTED_ENABLED_HTCAT                          (0x02)
#define DEM_OBD_RDY_BYTEC_1_COMPRESSION_SUPPORTED_ENABLED_NOXCAT                   (0x02)

#define DEM_OBD_RDY_BYTEC_2_SPARK_SUPPORTED_ENABLED_EVAP                           (0x04)

#define DEM_OBD_RDY_BYTEC_3_SPARK_SUPPORTED_ENABLED_SECAIR                         (0x08)
#define DEM_OBD_RDY_BYTEC_3_COMPRESSION_SUPPORTED_ENABLED_BOOSTPR                  (0x08)

#define DEM_OBD_RDY_BYTEC_4_SUPPORTED_ENABLED_RESERVED                             (0x10)

#define DEM_OBD_RDY_BYTEC_5_SPARK_SUPPORTED_ENABLED_O2SENS                         (0x20)
#define DEM_OBD_RDY_BYTEC_5_COMPRESSION_SUPPORTED_ENABLED_EGSENS                   (0x20)

#define DEM_OBD_RDY_BYTEC_6_SPARK_SUPPORTED_ENABLED_O2SENSHT                       (0x40)
#define DEM_OBD_RDY_BYTEC_6_COMPRESSION_SUPPORTED_ENABLED_PMFLT                    (0x40)

#define DEM_OBD_RDY_BYTEC_7_SPARK_SUPPORTED_ENABLED_EGR                            (0x80)

/* Byte D - Spark + Compression */
#define DEM_OBD_RDY_BYTED_0_SPARK_COMPLETENESS_READINESS_CAT                        (0x01)
#define DEM_OBD_RDY_BYTED_0_COMPRESSION_COMPLETENESS_READINESS_HCCAT                (0x01)

#define DEM_OBD_RDY_BYTED_1_SPARK_COMPLETENESS_READINESS_HTCAT                      (0x02)
#define DEM_OBD_RDY_BYTED_1_COMPRESSION_COMPLETENESS_READINESS_NOXCAT               (0x02)

#define DEM_OBD_RDY_BYTED_2_SPARK_COMPLETENESS_READINESS_EVAP                       (0x04)

#define DEM_OBD_RDY_BYTED_3_SPARK_COMPLETENESS_READINESS_SECAIR                     (0x08)
#define DEM_OBD_RDY_BYTED_3_COMPRESSION_COMPLETENESS_READINESS_BOOSTPR              (0x08)

#define DEM_OBD_RDY_BYTED_4_COMPLETENESS_READINESS_RESERVED                         (0x10)

#define DEM_OBD_RDY_BYTED_5_SPARK_COMPLETENESS_READINESS_O2SENS                     (0x20)
#define DEM_OBD_RDY_BYTED_5_COMPRESSION_COMPLETENESS_READINESS_EGSENS               (0x20)

#define DEM_OBD_RDY_BYTED_6_SPARK_COMPLETENESS_READINESS_O2SENSHT                   (0x40)
#define DEM_OBD_RDY_BYTED_6_COMPRESSION_COMPLETENESS_READINESS_PMFLT                (0x40)

#define DEM_OBD_RDY_BYTED_7_SPARK_COMPLETENESS_READINESS_EGR                        (0x80)
...
#define DEM_MAX_ENGINE_START_TIME_SINCE_DTCS_CLEARED              (0xFFFFU)
...
#define Dem_ResetFaultDectectionCounter_SUPPORT STD_ON

#else
	
#define Dem_ResetFaultDectectionCounter_SUPPORT STD_OFF

#endif

#if((DEM_NUMBER_OF_PRE_DEBOUNCE_COUNTER > 0U) || \
	(DEM_DEBOUNCE_TIME_SUPPORT == STD_ON) || \
	(DEM_NUMBER_OF_PRE_DEBOUNCE_COUNTER > 0U) || \
	(DEM_DEBOUNCE_TIME_SUPPORT == STD_ON))

#define Dem_InitDebounce_SUPPORT STD_ON

#else
	
#define Dem_InitDebounce_SUPPORT STD_OFF
