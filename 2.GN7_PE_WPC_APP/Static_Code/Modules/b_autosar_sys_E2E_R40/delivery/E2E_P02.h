...
**                                                                            **
**  SRC-MODULE: E2E_P02.h                                                     **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
**  PRODUCT   : AUTOSAR E2E Module                                            **
**                                                                            **
**  PURPOSE   : Header for E2E Profile 2 driver                               **
**                                                                            **
...
** 1.1.0    08-Mar-2016    Hoi-Min Kim     Changes made as per #3554, #4296,  **
...
#define E2E_P02_H_AR_RELEASE_MAJOR_VERSION            (4)
#define E2E_P02_H_AR_RELEASE_MINOR_VERSION            (2)
#define E2E_P02_H_AR_RELEASE_REVISION_VERSION         (2)

/* FILE VERSION INFORMATION */
#define E2E_P02_H_SW_MAJOR_VERSION                    (1)
#define E2E_P02_H_SW_MINOR_VERSION                    (2)
#define E2E_P02_H_SW_PATCH_VERSION                    (5)

/*******************************************************************************
**                      Macro definition                                      **
*******************************************************************************/

/* Maximum limit of counter value for E2E profile 2*/
#define  E2E_P02_CNT_LIMIT                          ((uint8)0x10)

/* Maximum value of counter for E2E profile 2*/
#define  E2E_P02_CNT_MAX                            ((uint8)0x0F)

/* Initil value for E2E_Profile 2 for CRC */
#define E2E_P02_CRC_INIT_VALUE                      ((uint8)0xFF)

/* XOR value for E2E_Profile 2 for CRC */
#define E2E_P02_CRC_XOR_VALUE                       ((uint8)0xFF)
...
/*******************************************************************************
**          Function Prototypes for E2E Profile 2                             **
*******************************************************************************/
