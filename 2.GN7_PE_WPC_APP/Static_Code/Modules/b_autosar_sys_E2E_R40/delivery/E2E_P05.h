...
**                                                                            **
**  SRC-MODULE: E2E_P05.h                                                     **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
**  PRODUCT   : AUTOSAR E2E Module                                            **
**                                                                            **
**  PURPOSE   : Header for E2E Profile 5 driver                               **
**                                                                            **
...
** 1.1.5    22-Jun-2017    Seongmin Kim    Changes made as per #7714          **
*******************************************************************************/
#ifndef E2E_P05_H
#define E2E_P05_H
...
#define E2E_P05_H_AR_RELEASE_MAJOR_VERSION            (4)
#define E2E_P05_H_AR_RELEASE_MINOR_VERSION            (2)
#define E2E_P05_H_AR_RELEASE_REVISION_VERSION         (2)

/* FILE VERSION INFORMATION */
#define E2E_P05_H_SW_MAJOR_VERSION                    (1)
#define E2E_P05_H_SW_MINOR_VERSION                    (2)
#define E2E_P05_H_SW_PATCH_VERSION                    (5)

/*******************************************************************************
**                      Macro Definitions                                     **
*******************************************************************************/
/* Maximum value of counter for E2E profile 5 */
#define E2E_P05_CNT_MAX                             ((uint8)0xFF)

/* Counter offset */
#define E2E_P05_CNT_OFS                             ((uint16)0x02)

/* The offset value of high byte of CRC */ 
#define E2E_P05_CRC_OFS_HIGH_BYTE                   ((uint16)0x1)

/* The offset value of low byte of CRC */ 
#define E2E_P05_CRC_OFS_LOW_BYTE                    ((uint16)0x0)

/* The start value for Crc calculation */
#define E2E_P05_CRC_START_VAL                       ((uint16)0xFFFF)
...
/*******************************************************************************
**          Function Prototypes for E2E Profile 5                             **
*******************************************************************************/
