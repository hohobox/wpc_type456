...
extern VAR(NvM_RedundantBlockStatusType, NVM_VAR) NvM_RedundantBlockStatus;

/* Flag to indicate status of processing of Redundant block */
extern VAR(NvM_RedundantBlockWriteOrderType, NVM_VAR)NvM_RedundantBlockWriteOrder;

/* Flag to indicate status of Writing of Redundant block */
extern VAR(uint8, NVM_VAR) NvM_RedundantBlockOrderUndefined;
...
extern P2VAR(uint8, AUTOMATIC, NVM_VAR) NvM_GpBufferToRead;
extern P2CONST(uint8, AUTOMATIC, NVM_CONST) NvM_GpBufferToWrite;

/* Pointer to the backup of RAM data block */
extern P2VAR(uint8, AUTOMATIC, NVM_VAR) NvM_GpBufferToReadOld;
extern P2CONST(uint8, AUTOMATIC, NVM_CONST) NvM_GpBufferToWriteOld;

/* Pointer to store write verify data */
extern P2CONST(uint8, AUTOMATIC, NVM_CONST) NvM_GpWriteVerifySourceData;
