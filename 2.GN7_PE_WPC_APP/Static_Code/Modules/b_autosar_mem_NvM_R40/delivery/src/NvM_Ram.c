...
VAR(NvM_RedundantBlockStatusType, NVM_VAR) NvM_RedundantBlockStatus;

/* Flag to indicate status of processing of Redundant block */
VAR(NvM_RedundantBlockWriteOrderType, NVM_VAR)NvM_RedundantBlockWriteOrder;

/* Flag to indicate status of Writing of Redundant block */
VAR(uint8, NVM_VAR)NvM_RedundantBlockOrderUndefined;
...
P2CONST(uint8, AUTOMATIC, NVM_CONST) NvM_GpBufferToWrite;
P2VAR(uint8, AUTOMATIC, NVM_DATA) NvM_GpBufferToRead;
  

/* Pointer to the backup of RAM data block */
P2VAR(uint8, AUTOMATIC, NVM_VAR) NvM_GpBufferToReadOld;
P2CONST(uint8, AUTOMATIC, NVM_CONST) NvM_GpBufferToWriteOld;

/* Pointer to store write verify data */
P2CONST(uint8, AUTOMATIC, NVM_CONST) NvM_GpWriteVerifySourceData;
