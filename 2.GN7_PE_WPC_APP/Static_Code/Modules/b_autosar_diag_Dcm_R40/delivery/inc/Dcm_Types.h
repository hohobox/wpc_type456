...
/*******************************************************************************
**                     DCM FBL TYPE Parameter                                 **
*******************************************************************************/

#ifndef DCM_AUTOEVER_FBL_UNUSED
#define DCM_AUTOEVER_FBL_UNUSED                                          (0x00u)
#endif
#ifndef DCM_AUTOEVER_FBL_USED_RXCONNECTION_ID_UNUSED
#define DCM_AUTOEVER_FBL_USED_RXCONNECTION_ID_UNUSED                     (0x01u)
#endif
#ifndef DCM_AUTOEVER_FBL_USED_RXCONNECTION_ID_USED
#define DCM_AUTOEVER_FBL_USED_RXCONNECTION_ID_USED                       (0x02u)
#endif
...
#define DCM_ROE_INTERMESSAGE_TIMER                                   ((uint8)5)
...
#define DCM_REQUESTFILETRANSFER                                      ((uint8)0x38)
...
/* This error code for FBL */
#define DCM_E_RESPONSE_AFTER_RESET                                   ((uint8)0x08)
...
/*******************************************************************************
**                      DET ADDITIONAL ERROR CODES                            **
*******************************************************************************/
/*    #46416 - To catch error reason, add det code in communcation modules    */

/* Request buffer is not accepted */
#define DCM_E_REQBUF_NOT_ACCEPTED                                   ((uint8)0x09)

/* Reception of message is canceled */
#define DCM_E_RECEPTION_CANCLED                                     ((uint8)0x0a)

/* Dcm status of start protocol is not allowed */
#define DCM_E_START_PROTOCOL_NOT_ALLOWED                            ((uint8)0x0b)

/* Response status has failed status */
#define DCM_E_RESP_FAILED_STATUS                                    ((uint8)0x0c)

/* Message length is zero */
#define DCM_E_MESSAGE_LEN_ZERO                                      ((uint8)0x0d)

/* Dcm start protocol failed */
#define DCM_E_START_PROTOCOL_FAILED                                 ((uint8)0x0e)

/* Dcm unreached case is occured */
#define DCM_E_UNREACHED_CASE_IS_OCCURED                             ((uint8)0x0f)
...
#elif (DCM_AUTHENTICATION_ES_SUPPORT == STD_ON)
#define DCM_CSAC_CONFIGURED (STD_ON)
#else
