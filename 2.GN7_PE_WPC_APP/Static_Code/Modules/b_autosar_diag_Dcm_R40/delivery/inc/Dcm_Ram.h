...
**                                                                            **
** 2.9.0.0   27-Nov-2023   GS Ryu            #42519                           **
**                                                                            **
...
**                                                                            **
** 2.3.18.0  24-01-2022    KaHyun   Kim    #33969                             **
**                                                                            **
...
extern VAR(boolean, DCM_VAR)Dcm_ChangeSessionLvOnReset;
...
extern VAR(boolean, DCM_VAR)Dcm_GblUpLoadActive;
  ...
  (DCM_TRANSFER_DATA_SERVICE == STD_ON))
extern VAR(boolean, DCM_VAR) Dcm_GblTransferDataApiInvoked;
#endif

#if(DCM_TRANSFER_EXIT_SERVICE == STD_ON)
extern VAR(boolean, DCM_VAR) Dcm_GblTransferExitDataApiInvoked;
#endif

#if((DCM_TRANSFER_DATA_SERVICE == STD_ON) && \
  (DCM_REQUEST_FILE_TRANSFER_SERVICE == STD_ON))
  extern VAR(boolean, DCM_VAR)Dcm_GblReadFileActive;
  extern VAR(boolean, DCM_VAR)Dcm_GblWriteFileActive;
  extern VAR(boolean, DCM_VAR)Dcm_GblResumeFileActive;
#endif
...
extern VAR(boolean, DCM_VAR) Dcm_GblStartRestoreSecurityAttemptCounters;
#endif
...
extern VAR(Dcm_TimerInfoType, DCM_VAR) Dcm_GaaSecurityTimerInfo[DCM_SECURITY_TIMER_MAX_NUM];

/* Global Variable to store seperate security access counters each security levels */
extern VAR(Dcm_SecurityLevStateType, DCM_VAR) Dcm_GaaSecLevState[
    DCM_NUM_OF_SECURITYLEVELCONFIG];
extern VAR(Dcm_AttCounterControlType, DCM_VAR) Dcm_GddAttCounterControl;
#endif
...
#if(DCM_ROUTINECONTROL_SERVICE == STD_ON)
extern P2VAR(uint8, AUTOMATIC, DCM_APPL_DATA) Dcm_GpRoutineSignalInDataPtr;
