...
#define WDGSTACK_ENABLE_EXTERNAL_WDG              (STD_OFF) // nidec : 모빌젠 설정에서 OFF 기능 안되므로 수동으로 OFF 처리함. OFF 처리 하지 않으면 Sleep 진입시 Windows expied 기간보다 너무 일직 pulser가 나와서 Reset 발생됨.
