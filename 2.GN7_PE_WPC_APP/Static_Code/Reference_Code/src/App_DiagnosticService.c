...
/* T32로 선택적으로 차종에 맞는 OEUK 인증 키를 OEUK_PUB_KEY_FLASH 어드레스에 Flash함. */
/* 여기 key 값을 FBL 에서 Direct address Read 하여 OEUK 인증시 사용함. */
/* default로 develop key가 flashing 됨. */

#if defined(DEBUG_OEUK_DEV_KEY_USE)
...
const uint8 Dcm_GaaPublicKeyData[260] = {
  ...
  #if cAppSoftVerCAR1 == '0' &&  cAppSoftVerCAR2 == '1' // GN7 PE
  const uint8 Dcm_GaaPublicKeyData[260] = {
    , 
    /*exponent 4 byte*/
    0x01, 0x00, 0x01, 0x00
  };
  #elif cAppSoftVerCAR1 == '0' &&  cAppSoftVerCAR2 == '2' // RX4 PE
  const uint8 Dcm_GaaPublicKeyData[260] = {
    , 
    /*exponent 4 byte*/
    0x01, 0x00, 0x01, 0x00
  };

  #else
    error message : Car type is not defined
  #endif // #if defined (cAppSoftVerCAR1)

#endif // #if defined(DEBUG_OEUK_DEV_KEY_USE)


#pragma ghs section rodata=default				/* 위치 지정 해제 */
/* 010D_01 */
  ...
  Dcm_OpStatusType OpStatus)
{
  ...
  switch(AppDcm_SignatureVerifySequence)
  {
    case SIGNATURE_VERIFY_START:
      ...
      {
        Dcm_GaaPublicKey.data[LucIndex] = Dcm_GaaPublicKeyData[LucIndex]; /* 010D_01 */
      }
	...
	switch(OpStatus)
	{
      ...
      switch(AppDcm_SignatureVerifyStatus)
      {
        case SIGNATURE_VERIFY_NONE:
          if (RTE_E_OK == Rte_Call_CsmKeyManagement_CryptoKey_OEUK_KeyElementSet(0x01, (const uint8*)&Dcm_GaaPublicKeyData, Dcm_LaaPublicKeyLength)) /* 010D_01 */
          {
