...
/* Alarm Handles */
#define OsAlarm_ASW_100ms                    ((AlarmType)3)
#define OsAlarm_ASW_10ms                     ((AlarmType)2)
#define OsAlarm_BG_Fota                      ((AlarmType)6)
#define OsAlarm_BG_KeyM                      ((AlarmType)5)
#define OsAlarm_BSW_10ms                     ((AlarmType)1)
#define OsAlarm_BSW_5ms_Com                  ((AlarmType)0)
#define OsAlarm_BSW_BG_Mem_76_Pfls_Main      ((AlarmType)7)
#define OsAlarm_BSW_Crypto_Main              ((AlarmType)4)
...
/* Event Handles */
#define OsEvent_BSW_BG_Fota                  ((EventMaskType)4096)
#define OsEvent_BSW_Crypto_Main              ((EventMaskType)32768)
#define OsEvent_BSW_KeyM                     ((EventMaskType)16384)
#define OsEvent_BSW_Mem_76_Pfls_Main         ((EventMaskType)8192)

/* Isr Handles */
#define Can_Interrupt_CANFD02_Cat2           ((ISRType)13)
#define GPT_Isr_Vector_303_Cat2              ((ISRType)15)
#define GPT_Isr_Vector_307_Cat2              ((ISRType)14)
#define Hsm_Isr_Vector_4_Cat2                ((ISRType)16)
#define OsIsrOsCounter_0                     ((ISRType)17)
...
#define OsTask_BSW_BG_Fota                   ((TaskType)10)
#define OsTask_BSW_BG_KeyM                   ((TaskType)9)
#define OsTask_BSW_BG_Mem_76_Pfls_Main       ((TaskType)11)
#define OsTask_BSW_ComMModeRequest           ((TaskType)4)
#define OsTask_BSW_Crypto_Main               ((TaskType)12)
#define OsTask_BSW_FG1_10ms                  ((TaskType)5)
#define OsTask_BSW_FG1_5ms_Com               ((TaskType)6)
#define OsTask_BSW_FG2_WdgMAPI               ((TaskType)7)
#define OsTask_BSW_Init                      ((TaskType)8)
...
extern void TASK_OsTask_BSW_BG_Mem_76_Pfls_Main(void);
extern void TASK_OsTask_BSW_Crypto_Main(void);
