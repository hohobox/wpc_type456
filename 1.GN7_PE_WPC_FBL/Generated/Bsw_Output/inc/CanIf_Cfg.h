...
#define CANIF_PDUR_CALLBACK                 (STD_OFF)
...
#define CANIF_RX_PDUR_CALLBACK              (STD_OFF)
...
#define CANIF_TX_PDUR_CALLBACK              (STD_OFF)
...
/* Pre-compile option for Cancel transmit support */
#define CANIF_RX_STANDARD_CANID_ONLY        (STD_ON)

/* Pre-compile option for Cancel transmit support */
#define CANIF_RX_EXTENDED_CANID_ONLY        (STD_OFF)

/* Pre-compile option for Cancel transmit support */
#define CANIF_RX_EXT_STD_CANID              (STD_OFF)
...
/* Number of Rx L-PDU */
#define CANIF_NO_OF_RXLPDU                   ((PduIdType)2)

/* Number of Tx L-PDU */
#define CANIF_NO_OF_TXLPDU                   ((PduIdType)1)

/* Number of Hrh */
#define CANIF_NO_OF_HRH                      ((uint16)2)
