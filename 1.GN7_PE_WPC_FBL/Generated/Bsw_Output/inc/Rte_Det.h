...
FUNC(Std_ReturnType, Det_CODE) Det_ReportError(IN VAR(uint16, AUTOMATIC) PortDefinedArgument_1, IN VAR(uint8, AUTOMATIC) InstanceId, IN VAR(uint8, AUTOMATIC) ApiId, IN VAR(uint8, AUTOMATIC) ErrorId);
