...
**                        Function(s) invoked :                               **
*******************************************************************************/
/* polyspace-begin MISRA-C3:8.4 [Justified:Low] "It can be replaced with BswM_MainFunction_Main
   depending on whether it is multi-core or not" */
...
/* polyspace-end MISRA-C3:8.4 [Justified:Low] "It can be replaced with BswM_MainFunction_Main
   depending on whether it is multi-core or not" */
