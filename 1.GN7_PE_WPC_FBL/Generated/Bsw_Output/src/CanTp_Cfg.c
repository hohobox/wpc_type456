...
#define CANTP_CFG_C_SW_PATCH_VERSION                       (3)
/*******************************************************************************
**                      Version Check                                         **
*******************************************************************************/
...
VAR(CanTp_ChannelRam, CANTP_VAR)CanTp_GaaChannelRam[2];


/* Array for N_As/N_Ar, N_Bs/N_Br, N_Cs/N_Cr Timersfor all the channels */
VAR(uint16, CANTP_VAR)CanTp_GaaTimers[2][3];


/* Array for STMin timers of all channels*/
VAR(uint8, CANTP_VAR)CanTp_GaaStMinTimers[2];
...
CONST(CanTp_RxNSduDynamic, CANTP_CONST) CanTp_GaaRxSduDynamic[] =
{
  ...
  /* RxNSDU 1 - CanTpConfig_CanTpChannel_1_RxOnly_Pdu_DcmIPdu_BCAN_GST_ALL_CanTpRxNSdu_1_Pdu_DcmIPdu_BCAN_GST_ALL_1 */
  {
    /* ddUpTargetPduId */
    0x0001,
...
CONST(CanTp_RxNsduStatic, CANTP_CONST) CanTp_GaaRxSduStatic[] =
{
  ...
  /* RxNSDU 1 - CanTpConfig_CanTpChannel_1_RxOnly_Pdu_DcmIPdu_BCAN_GST_ALL_CanTpRxNSdu_1_Pdu_DcmIPdu_BCAN_GST_ALL */
  {
    /* ddChannelId */
    1,
...
VAR(CanTp_STminBs, CANTP_VAR) CanTp_GaaSTminBs[] =
{
  ...
  /* RxNSduRam 1 - CanTpConfig_CanTpChannel_1_RxOnly_Pdu_DcmIPdu_BCAN_GST_ALL_CanTpRxNSdu_1_Pdu_DcmIPdu_BCAN_GST_ALL */
  {
    /* usBlockSize */
    0x0000,
