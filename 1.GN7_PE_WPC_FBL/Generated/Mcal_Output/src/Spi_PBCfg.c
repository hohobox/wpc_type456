...
/* Ensure that the buffer is 4-byte-aligned. */
...
static VAR(Spi_DataBufferType, SPI_VAR_NO_INIT) Spi_ChRxB_SpiChannel_0[1];
...
static VAR(Spi_DataBufferType, SPI_VAR_NO_INIT) Spi_ChTxB_SpiChannel_0[1];
