...
********************************************************************************
** 1.11.1    13-Jul-2023   HT Kim      #40021                                 **
** 1.10.2    30-Dec-2021   Js Lim      #33363                                 **
...
extern FUNC(Std_ReturnType, COMM_CODE) ComM_GetChannelBusLoad (VAR(NetworkHandleType, 
   COMM_VAR_POWER_ON_INIT) Channel, P2VAR(ComM_BusMsgType, AUTOMATIC, COMM_APPL_DATA) BusLoad);
