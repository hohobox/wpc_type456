...
#define CANSM_TXTIMEOUTEXCEPTION                  ((uint8) 0x0C)
...
/* Macros to check if CanDrv's Autosar version */
#define CANSM_AR_RELEASE_VERSION_THREE            (3)
#define CANSM_AR_RELEASE_VERSION_FOUR             (4)

/* Macros to support both AR40 and AR44 CanDrv */
#if ((CAN_AR_RELEASE_MAJOR_VERSION == CANSM_AR_RELEASE_VERSION_FOUR)\
  && (CAN_AR_RELEASE_MINOR_VERSION >= CANSM_AR_RELEASE_VERSION_THREE))
#define CANSM_CS_UNINIT                           (CAN_CS_UNINIT)
#define CANSM_CS_STARTED                          (CAN_CS_STARTED)
#define CANSM_CS_STOPPED                          (CAN_CS_STOPPED)
#define CANSM_CS_SLEEP                            (CAN_CS_SLEEP)
#else
#define CANSM_CS_UNINIT                           (CANIF_CS_UNINIT)
#define CANSM_CS_STARTED                          (CANIF_CS_STARTED)
#define CANSM_CS_STOPPED                          (CANIF_CS_STOPPED)
#define CANSM_CS_SLEEP                            (CANIF_CS_SLEEP)
