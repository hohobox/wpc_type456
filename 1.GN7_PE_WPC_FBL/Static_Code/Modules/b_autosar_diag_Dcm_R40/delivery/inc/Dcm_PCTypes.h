...
**                                                                            **
** 2.11.0.0  31-Jan-2024   Donghee Kwak       #44489, #44470                  **
**                                                                            **
** 2.10.0.0  28-Dec-2023   Suyon Kim          #42075                          **
**                                                                            **
** 2.9.0.0   27-11.2023    GS Ryu             #410443                         **
**                                                                            **
...
**                                                                            **
** 2.5.1.0   12-Aug-2022   LanhLT         Fix UNECE #35929                    **
**                                                                            **
...
/*pointer for Dcm_RequestContextType*/
typedef P2VAR(Dcm_RequestContextType, AUTOMATIC, DCM_APPL_DATA) Dcm_RequestContextType_Ptr;

#if 0
/* Manage security timers separately from the Dcm_GaaTimer */
...
typedef struct STagDcm_PduIdTable
{
  ...
  /* Connection Id configured in DcmDslMainConnection and provided
     for the jump to Bootloader */
  uint16 usRxConnectionId;
...
/*******************************************************************************
** const ponter for Dcm_DiagSessionConfigType                                 **
*******************************************************************************/
typedef P2CONST(Dcm_DiagSessionConfigType, AUTOMATIC, DCM_APPL_CONST) Dcm_DiagSessionConfigType_Ptr;
...
/*******************************************************************************
** const pointer for Dcm_SubServiceIdConfigType                               **
*******************************************************************************/

typedef P2CONST(Dcm_SubServiceIdConfigType, AUTOMATIC, DCM_CONST) Dcm_SubServiceIdConfigType_Ptr;
...
/*******************************************************************************
** const pointer for Dcm_ServiceIdConfigType                                  **
*******************************************************************************/
typedef P2CONST(Dcm_ServiceIdConfigType, AUTOMATIC, DCM_CONST)
  Dcm_ServiceIdConfigType_Ptr;
/*******************************************************************************
...
/*******************************************************************************
** const Pointer for Dcm_ProtocolConfig                                       **
*******************************************************************************/
typedef P2CONST(Dcm_ProtocolConfig, AUTOMATIC, DCM_CONST) Dcm_ProtocolConfig_Ptr;
...
/*******************************************************************************
**  const pointer for Dcm_BufferConfig                                        **
*******************************************************************************/
typedef P2CONST(Dcm_BufferConfig, AUTOMATIC, DCM_APPL_CONST) Dcm_BufferConfig_Ptr;
...
typedef P2FUNC(Std_ReturnType, DCM_APPL_CODE, Dcm_ShortTermAdjustmentFixedAsyncType)(
  P2CONST(uint8, AUTOMATIC, DCM_APPL_CONST) pControlOptionRecord,
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_APPL_DATA) pErrorCode
);
...
/*Ponter for the Dcm_DidRangeConfig */
typedef P2VAR(Dcm_DIDRangeConfig, AUTOMATIC, DCM_APPL_DATA) Dcm_DIDRangeConfig_Ptr;
#endif
/*******************************************************************************
...
typedef struct STagDcm_RoutineConfigType
{
  ...
  #if (DCM_AUTHENTICATION_SUPPORT == STD_ON)
  Dcm_AuthenticationRoleType StartRoutineRole;

  Dcm_AuthenticationRoleType StopRoutineRole;

  Dcm_AuthenticationRoleType RoutineResultsRole;
  #endif
...
typedef struct STagDcm_SecurityLevConfigType
{
  ...
  P2FUNC(Std_ReturnType, DCM_APPL_CODE, pGetSeedAsyncFun)
    (P2CONST(uint8, AUTOMATIC, DCM_APPL_CONST) SecurityAccessRecord,
    Dcm_OpStatusType OpStatus,
    P2VAR(uint8, AUTOMATIC, DCM_APPL_DATA) Seed,
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_APPL_DATA) Error);
  ...
  P2FUNC(Std_ReturnType, DCM_APPL_CODE, pCompareKeyAsyncFun)
    (P2CONST(uint8, AUTOMATIC, DCM_APPL_CONST) Key, Dcm_OpStatusType OpStatus,
     P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_APPL_DATA) Error);

  /* Function to get the AttemptCounter value from the application */
  P2FUNC(Std_ReturnType, DCM_APPL_CODE, pGetSecurityAttemptCounterFun)
    (Dcm_OpStatusType OpStatus,
    P2VAR(uint8, AUTOMATIC, DCM_APPL_DATA) AttemptCounter);

  /* Function to set the AttemptCounter value to the application */
  P2FUNC(Std_ReturnType, DCM_APPL_CODE, pSetSecurityAttemptCounterFun)
    (Dcm_OpStatusType OpStatus,
    uint8 AttemptCounter);
  #endif

  /* Existence of the APIs set/get the AttemptCounter values toward application */
  boolean blAttemptCounterEnabled;
...
/*******************************************************************************
** const pointer for Dcm_SecurityLevConfigType                                **
*******************************************************************************/
...
#if (DCM_NUM_OF_SECURITY_ATTEMPT_COUNTER_ENABLED != DCM_ZERO)
#define SECURITY_ATTEMPT_COUNTER_ENABLED
/* Max write time is hard to 100 times of main function */
#define DCM_MAX_ATTEMPT_COUNTER_WRITEOUT_TIME (100 * DCM_TASK_TIME)
#endif
#endif
...
typedef enum 
{
  ...
  DCM_SECURITY_TIMER_MAX_NUM
  #else
  DCM_SECURITY_TIMER_MAX_NUM
  #endif
} Dcm_SecurityAccess_TimerType;
...
typedef P2FUNC(Std_ReturnType, DCM_APPL_CODE, Dcm_IndicationFunType)(
  uint8 SID, 
  P2CONST(uint8, AUTOMATIC, DCM_APPL_CONST) RequestData,
  uint16 DataSize, 
  uint8 ReqType, 
...
typedef struct STagDcm_ServiceForcePendingStatusType
{
  ...
  uint8 ucFileTransferForcePendingStatus;
...
typedef struct STagDcm_MemServicePendingStatusType
{
  ...
  uint8 ucFileTransferPendingStatus;
...
typedef struct STagDcm_DspServiceProcessingStsType
{
  ...
  uint8 ucSecSetAttemptCounterPending;
  uint8 ucSecSeedReq;
...
typedef struct STagDcm_AuthenticationConnectionESConfigType
{
  ...
  P2FUNC(Std_ReturnType, DCM_CALLOUT_CODE, pSettingAccessRightsFailedFun)(
  P2VAR(Dcm_CertAuthorizationInfoType, AUTOMATIC, DCM_APPL_DATA) authorization,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_APPL_DATA) Error);

  P2FUNC(Std_ReturnType, DCM_CALLOUT_CODE, pDeauthenticationFailedFun)(
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext,
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_APPL_DATA) Error);
...
typedef struct STagDcm_AuthenticationElementType
{
  ...
  P2VAR(uint8, AUTOMATIC, DCM_APPL_DATA) pData;

  uint32 DataMaxLen; // maximum length of pData
...
typedef struct STagDcm_AuthenticationConnectionConfigType
{
  ...
  KeyM_CertificateIdType ClientCertId;
...
/*******************************************************************************
** Structure declaration of File Transfer Services                            **
*******************************************************************************/
...
typedef P2FUNC(Std_ReturnType, DCM_CALLOUT_CODE, Dcm_ProcessRequestResumeFileFuncType)(
  Dcm_OpStatusType OpStatus
  , uint16 FilePathAndNameLength
  , P2CONST(uint8, AUTOMATIC, DCM_APPL_CONST) FilePathAndName
  , uint8 DataFormatIdentifier
...
typedef struct StagDcm_FileTransferFncConfigType
{
  ...
  /* Function to process Request Read Dir */
  Dcm_ProcessRequestResumeFileFuncType pProcessRequestResumeFileFnc;
...
/*******************************************************************************
** Data of File Transfer Services                                             **
*******************************************************************************/
#if (DCM_REQUEST_FILE_TRANSFER_SERVICE == STD_ON)
#define DCM_START_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
...
#define DCM_GET_DATAID_FROM_REQUEST(lvalue, rvalue, pos, next_pos) \
do {\
  (lvalue) = (uint16)(rvalue)[(pos)];\
  (lvalue) = (uint16)((lvalue) << 8U);\
  (lvalue) = (lvalue) | (uint16)(rvalue)[(next_pos)];\
} while(0)
...
#define DCM_START_SEC_CONST_8
#include "MemMap.h"
extern CONST(uint16, DCM_CONST) Dcm_GaaAuthConnectionIds[
