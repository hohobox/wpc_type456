...
** 2.9.0     30-Jun-2022   HT Kim      Internal Redmine #35740                **
...
#define COM_PCTYPES_SW_MINOR_VERSION  9
...
typedef struct
{
  ...
  /* Pointer to Substitute value. Generation tool should allocate pointer
  to Substitute value if the timeout substitute has been configured for the
  signal otherwise it should point to NULL pointer */
  P2CONST(void, AUTOMATIC, COM_CONST) pSubstituteValue;
...
typedef struct
{
  ...
  */
  ...
  uint16 usRamInit8BitSize;
  uint16 usRamInit16BitSize;
  uint16 usRamInit32BitSize;

  uint32 ulRamInit8BitStartIdx;
  uint32 ulRamInit16BitStartIdx;
  uint32 ulRamInit32BitStartIdx;
  #endif
...
typedef struct
{
  ...
  /* uint8 -> uint16 for supporting huge data - Fixed by AUTOEVER START*/  
  ...
  /* uint8 -> uint16 for supporting huge data - Fixed by AUTOEVER END*/  
...
typedef struct
{
  ...
  /* Insert update bit configuration featuring by AUTOEVER #938 */
  #if(COM_RX_SIGGROUP_UB == STD_ON)
...
**                      Global Data Types                                     **
*******************************************************************************/
#if(COM_RX_SDU_LENGTH_SIZE > COM_MACRO_ZERO)
#define COM_START_SEC_VAR_CLEARED_UNSPECIFIED
	#include "MemMap.h"
/* Global array for holding the Ipdu length of Rx Ipdu's */
extern VAR(PduLengthType, COM_VAR)Com_GaaRxSduLength[COM_RX_SDU_LENGTH_SIZE];
...
/* Array size calculation error - Fixed by AUTOEVER START*/  
...
#include "MemMap.h"
#endif
/* Array size calculation error - Fixed by AUTOEVER END*/  
...
& Memory arragement - Fixed by AUTOEVER START*/  
#define COM_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
...
/* uint16 -> PduLengthType for variable which has Pdu Length info 
& Memory arragement - Fixed by AUTOEVER END*/  
