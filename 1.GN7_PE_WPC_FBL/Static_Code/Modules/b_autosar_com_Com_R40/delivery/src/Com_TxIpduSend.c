...
********************************************************************************
** 2.9.2.0   24-Aug-2022   DH Choi     Internal Redmine #37244, #36994        **
...
#define COM_TXIPDUSEND_C_SW_MINOR_VERSION  9
...
#endif
{
  /* Pointer to Tx mode structure */
        ...
        (((COM_PERIODIC_MESSAGE == STD_ON) || (COM_TX_IPDU_MINDELAY_ENABLED == STD_ON) ||\
        (COM_TX_IPDU_REPETITION == STD_ON) || (COM_MAINFUNC_BASED_TRANSMIT  == STD_OFF) || (COM_TX_IPDU_DM == STD_ON))))
  ...
  #if((COM_TX_IPDU_TMS_SIG_BASED == STD_ON)|| \
      ((COM_TX_IPDU_MINDELAY_ENABLED == STD_ON) && (COM_TX_IPDU_MDT_COUNT < COM_TX_IPDU_COUNT)))
  ...
  #else
  {
                                                                   ...
                                                                   == COM_FALSE)
    {
      if((LpTxIpdu->ddTrueTxModeIndex+(PduIdType)COM_ONE) < COM_TX_MODE_COUNT)
      {
        ...
        (COM_MIXED_NTIMES_MESSAGE == STD_ON) || (COM_MIXED_MESSAGE == STD_ON))
    #if(COM_PERIODIC_MESSAGE == STD_ON)
    if(((LpTxMode->ucTxMode > COM_TX_PERIODIC_MODE)))
    #endif
    {
      LucTransmitFlag = COM_TRUE;
  ...
  #if((COM_DIRECT_MESSAGE == STD_ON)||(COM_MIXED_MESSAGE == STD_ON)||\
      (COM_DIRECT_NTIMES_MESSAGE == STD_ON)||(COM_MIXED_NTIMES_MESSAGE == STD_ON))  
