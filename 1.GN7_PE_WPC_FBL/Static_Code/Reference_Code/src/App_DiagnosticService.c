...
/* 010D_01 */
/* PubKey를 App Flash에서 가져다 씀 */
typedef uint8 PubKey_t[260];
volatile const PubKey_t* App_Dcm_GaaPublicKeyData = (PubKey_t*)0x10059000U; 
/* 010D_01 */
...
const uint8 Fbl_Version_Info[32] = {cFblSoftVerYear1, cFblSoftVerYear2, cFblSoftVerMonth, cFblSoftVerOrder, cFblSoftVerUsage, \
                                    cAppSoftVerCAR1, cAppSoftVerCAR2, cAppSoftVerIndex1, cAppSoftVerIndex2, \
                                    cSWP_FBL_VER1,cSWP_FBL_VER2,cSWP_FBL_VER3, 0x00, 0x00, 0x00, 0x00,\
  ...
  Dcm_OpStatusType OpStatus)
{
  ...
  switch(AppDcm_SignatureVerifySequence)
  {
    case SIGNATURE_VERIFY_START:
      ...
      {
        Dcm_GaaPublicKey.data[LucIndex] = ((uint8*)App_Dcm_GaaPublicKeyData)[LucIndex]; /* 010D_01 */
      }
	...
	switch(OpStatus)
	{
      ...
      switch(AppDcm_SignatureVerifyStatus)
      {
        case SIGNATURE_VERIFY_NONE:
          if (RTE_E_OK == Rte_Call_CsmKeyManagement_CryptoKey_OEUK_KeyElementSet(0x01, (const uint8*)App_Dcm_GaaPublicKeyData, Dcm_LaaPublicKeyLength)) /* 010D_01 */
          {
