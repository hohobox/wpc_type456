...
extern FUNC(Std_ReturnType, MEM_76_PFLS_CODE) Mem_76_Pfls_WdgEnable_Callout(uint32 instanceID);
extern FUNC(Std_ReturnType, MEM_76_PFLS_CODE) Mem_76_Pfls_WdgDisable_Callout(uint32 instanceID);
