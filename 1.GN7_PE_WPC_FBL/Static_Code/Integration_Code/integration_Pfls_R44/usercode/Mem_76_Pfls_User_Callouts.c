...
FUNC(Std_ReturnType, MEM_76_PFLS_CODE) Mem_76_Pfls_WdgDisable_Callout(uint32 instanceID)
{
    Std_ReturnType retVal;
    retVal = E_OK;
    retVal = WdgM_SetMode(WDGM_WDGMMODE2,300);
    return retVal;
}

FUNC(Std_ReturnType, MEM_76_PFLS_CODE) Mem_76_Pfls_WdgEnable_Callout(uint32 instanceID)
{
    Std_ReturnType retVal;
    retVal = E_OK;
    retVal = WdgM_SetMode(WDGM_WDGMMODE1,300);
    return retVal;
}
