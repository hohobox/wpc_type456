...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Fota_R44\generator\Bswmdt_Fota.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Fota_R44\generator\Swcd_Fota.template
